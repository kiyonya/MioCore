...
export default class NeoForgeInstaller extends EventEmitter {
    ...
    public async install() {
        ...
        //生成版本JSON
        const versionJsonFragment = JSON.parse(fs.readFileSync(neoforgeVersionJsonPath, 'utf-8'))
        //清理文件
        try {
            fs.rmSync(this.neoforgeWorkDir, { recursive: true, force: true })
        } catch (error) {
